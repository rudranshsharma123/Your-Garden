...
// import 'package:yourgarden/Screens/Signup_page.dart';
      ...
      body: Column(
        ...
        children: [
          Expanded(
            child: ListView(
              children: <Widget>[
                MessageBubble(sender: "lol", text: "hola", isMe: true),
                MessageBubble(sender: "lol", text: "hola", isMe: false),
                MessageBubble(sender: "lol", text: "hola", isMe: false),
                // MyFormField(pass: false,),
              ],
            ),
          ),
          ChatFormField(
